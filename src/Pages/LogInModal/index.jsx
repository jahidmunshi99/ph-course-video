  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900/90">
      <div className="w-full max-w-md bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-700 relative">
        ...
        <img
          className="w-[60px] h-[60px] mx-auto border-1 rounded-4xl p-2 text-white mb-6"
          src={brandLogo}
          alt=""
        />
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-700 text-white rounded-lg border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
              required
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full px-4 py-3 bg-gray-700 text-white rounded-lg border border-gray-600 pr-12 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
              required
            />
            <button
              type="button"
        ...
        <button
          ...
          className="w-full flex items-center justify-center py-3 px-4 bg-gray-700 text-white font-semibold rounded-lg border border-gray-600 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition duration-200"
        >
          {/* Google Logo SVG */}
          <svg
