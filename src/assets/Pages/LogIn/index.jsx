    ...
    <div className="flex items-center justify-center bg-gray-900 min-h-screen">
      <div className=" bg-white shadow-lg rounded-lg p-8 w-sm">
        ...
        <form ref={formRef} onSubmit={handleLogIn}>
          <div className="">
            ...
            <div className="my-3 flex justify-between">
              ...
              {/* Reset Password */}
              <Link className="block text-sm font-medium text-gray-600 cursor-pointer hover:text-gray-800">
                Reset Password
              </Link>
            </div>
          </div>
        ...
        <p className="mt-4 text-center text-sm text-gray-500">
          ...
          <Link
            to="/signup"
            className="font-bold hover:underline text-[#EF4444] pl-3 cursor-pointer"
          >
            SignUp/Register
          </Link>
          .
